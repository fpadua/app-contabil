...
const INDEX_CATALOG = [
  ...
  { slug: "igp_di", name: "IGP-DI (FGV)", path: "/tabelas/igp-fgv-indice-geral-de-precos" },
  { slug: "incc_di", name: "INCC-DI (FGV)", path: "/tabelas/incc-indice-nacional-da-construcao-civil" },
  { slug: "ipc_fipe", name: "IPC (FIPE)", path: "/tabelas/ipc-indice-de-precos-ao-consumidor-fipe" },
  { slug: "ipc_fgv", name: "IPC (FGV)", path: "/tabelas/ipc-indice-de-precos-ao-consumidor-fgv" },
  { slug: "ivar", name: "IVAR (FGV)", path: "/tabelas/ivar-indice-variacao-de-alugueis-residenciais" },
  { slug: "tr", name: "TR (Bacen)", path: "/tabelas/tr-bacen" },
  { slug: "cdi", name: "CDI (CETIP)", path: "/tabelas/cdi" },
  { slug: "btn_tr", name: "BTN-TR", path: "/tabelas/btn-bonus-do-tesouro-nacional" },
  { slug: "salario_minimo", name: "Salário Mínimo", path: "/tabelas/salario-minimo" },
  { slug: "poupanca", name: "Poupança", path: "/tabelas/poupanca" },
  { slug: "selic", name: "Selic", path: "/tabelas/selic" },
  { slug: "taxa_legal", name: "Taxa Legal", path: "/tabelas/taxaLegal" },
  { slug: "tbf", name: "TBF", path: "/tabelas/tbf" },
  { slug: "tjlp", name: "TJLP (Bacen)", path: "/tabelas/tjlp" },
  { slug: "ufesp", name: "Ufesp", path: "/tabelas/ufesp" },
  { slug: "ufir", name: "Ufir", path: "/tabelas/ufir" },
  { slug: "ufr", name: "UFR (PB)", path: "/tabelas/ufr-pb" },
  { slug: "upc", name: "UPC", path: "/tabelas/upc-unidade-padrao-de-capital" },
  { slug: "ufm", name: "UFM (SP)", path: "/tabelas/ufm-sp" },
];
