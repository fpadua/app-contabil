...
| REGRA-SAC-001 | `FONTE-SAC-IPCA-001` | `SAC 163 mil!D13`, colunas C:J | Amortização constante, juros sobre saldo e correção mensal | A implementar | Mapeada |
| REGRA-SAC-002 | `FONTE-SAC-TR-001` | `Plan1!H11`, colunas C:Q | SAC corrigido pela TR | A implementar | Mapeada |
| REGRA-PRICE-001 | `FONTE-PRICE-IGPM-001` | `Plan1`, colunas C:P | Price com correção por IGP-M | A implementar | Mapeada |
...
| REGRA-JUD-001 | `FONTE-DIF-SALARIAL-001` | `Plan 1!F12:M12` | IPCA-E e poupança até 08/12/2021; Selic após 09/12/2021 | A implementar | Mapeada |
